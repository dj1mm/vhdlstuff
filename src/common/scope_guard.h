...
//
// while waiting for scope guards to become part of the c++ ts, I have copied
// this header file from above website on the 16th October 2021 at 2357 BST
...
namespace common
{
  namespace detail
  {
    ...
    common::detail::scope_guard from befriending a common::make_scope_guard
